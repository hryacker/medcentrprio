...
var swiper_main_page_news = new _swiperBundle.default('.swiper-news', {
  ...
  navigation: {
    nextEl: '.news .swiper-btn-next, .btn-next',
    prevEl: '.news .swiper-btn-prev, .btn-prev'
  },
  pagination: {
    el: ".swiper-pagination"
  }
...
var swiper_our_center = new _swiperBundle.default('.swiper-tabs', {
  ...
  navigation: {// nextEl: '#join-us .swiper-button-next',
...
$('.our-center .tabs__link').click(function () {
  var $this = $(this);
  if ($this.hasClass('tabs__link--active')) return;
  $this.parents().siblings('.swiper-slide').find('.tabs__link--active').removeClass('tabs__link--active');
  $this.addClass('tabs__link--active');
  var data_tab_id = $this.attr('data-tab-id');
  $('.tab-content').not($("[data-tab-content=".concat(data_tab_id, "]"))).removeClass('tab-content--active');
  $("[data-tab-content=".concat(data_tab_id, "]")).addClass("tab-content--active");
});
/* -------- END НАШ ЦЕНТР ------- */
